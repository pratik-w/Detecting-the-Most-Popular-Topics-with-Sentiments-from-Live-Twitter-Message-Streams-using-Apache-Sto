...
public class ReportBolt extends BaseRichBolt {
	...
	public void prepare(Map config, TopologyContext context,
		...
		System.out.println("____________________________Report BOLT being created_______________________________________________");
	      try{
	  		_log = new PrintWriter(new File("/s/chopin/b/grad/hari7988/xyz/HashReport.txt"));
	  		}catch (Exception e) {
...
//		int sentiment=(int)tuple.getValueByField("sentimentScore");
		...
		element.sentimentScore=(int)tuple.getValueByField("sentimentScore");
